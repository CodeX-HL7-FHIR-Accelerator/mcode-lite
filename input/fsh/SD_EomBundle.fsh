...
// * insert BundleSlice(eomPatient, 1, 1, Cancer Patient, The Cancer Patient whose data is included in the bundle., EomCancerPatient)
* entry contains 
...
* entry[mcodeObservations] ^short = "FHIR Observation Resources, if they exist for the patient, including but not limited to: CancerDiseaseStatus, CancerStage (TNM and non-TNM), Comorbidities, ECOGPerformanceStatus, GenomicRegionStudied, KarnofskyPerformanceStatus, TumorMarkerTest."
